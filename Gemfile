...
gem 'mongoid',                  '~> 7.0.2'
gem 'mongo',                    '~> 2.6'
gem 'mongo_session_store', '~> 3.2', '>= 3.2.0'
...
gem 'net-ssh',                  '= 4.2.0'
gem 'nokogiri', '~> 1.11.0'
gem 'nokogiri-happymapper', '~> 0.8.1', :require => 'happymapper'
...
group :test do
  gem 'action_mailer_cache_delivery', '~> 0.3', '>= 0.3.7'
