...
class RemoveResidentRole < MongoidMigrationTask
  ...
  def migrate
    ...
    people.each do |person|
      ...
      next if correct_assignments.include?(person.hbx_id.to_s)
      ...
      person_reload ||= Person.find(person.id)
      copy_resident_role_to_consumer_role(person_reload.resident_role) if person_reload.resident_role.present? && person_reload.consumer_role.nil?
      person_reload.resident_role.destroy if person_reload.resident_role.present?
