...
class DelinkBrokerGeneralAgency < MongoidMigrationTask
  def migrate
    ...
    puts "Updated General agency information and deleted old Broker agency profile" if ga_org.broker_agency_profile.blank? && !Rails.env.test?
    ...
    broker_agency_profile = BrokerAgencyProfile.new(:id => BSON::ObjectId('57961bf1f1244e3ece000064'), :organization => organization,entity_kind: "s_corporation", market_kind: "shop", corporate_npn: nil,
                                                    primary_broker_role_id: BSON::ObjectId('57961bf1f1244e3ece000062'), default_general_agency_profile_id: BSON::ObjectId('57589d8bf1244e54170000ab'), languages_spoken: ["", "en"], working_hours: true, accept_new_clients: true, aasm_state: "is_approved")
