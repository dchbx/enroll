...
module Employers
  class EmployerProfilesController < Employers::EmployersController
    ...
    def link_from_quote
      ...
      elsif @employer_profile.build_plan_year_from_quote(claim_code, import_roster)
...
# Should be in ER attestations controller
    def new_document
