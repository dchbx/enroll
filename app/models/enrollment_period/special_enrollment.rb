...
module EnrollmentPeriod
  class SpecialEnrollment < EnrollmentPeriod::Base
  ...
  # Timestamp when SEP was reported to HBX
    ...
    def first_of_month_effective_date
      if @reference_date.day <= EnrollmentPeriod::SpecialEnrollment.individual_market_monthly_enrollment_due_on
    ...
    def calculate_effective_on_for_moved_qle
      ...
      elsif qle_on == qle_on.beginning_of_month
