...
module Effective
  module Datatables
    class OutstandingVerificationDataTable < Effective::MongoidDatatable
      ...
      def collection
        @families = Queries::OutstandingVerificationDatatableQuery.new(attributes) unless (defined? @families) && @families.present? #memoize the wrapper class to persist @search_string
        @families
      end
