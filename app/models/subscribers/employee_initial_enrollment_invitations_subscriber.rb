...
module Subscribers
  class EmployeeInitialEnrollmentInvitationsSubscriber < ::Acapi::Subscription
    include Acapi::Notifiers

    def self.subscription_details
      ["acapi.info.events.plan_year.employee_initial_enrollment_invitations_requested"]
    end
    ...
    def process_response(payload)
      ...
      benefit_application.send_employee_initial_enrollment_invites
