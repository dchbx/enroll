...
csv_glue = CSV.read("/Users/Varun/Desktop/reports/10655_export_glue_multi_row_sep_16_cancelled.csv", :headers => true)
...
csv_mismatch = CSV.open("final_ea_report_sep_16.csv", "w")
