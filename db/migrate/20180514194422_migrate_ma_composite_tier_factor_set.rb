...
class MigrateMaCompositeTierFactorSet < Mongoid::Migration
  def self.up
    if Settings.site.key.to_s == "cca"
      ...
      CompositeRatingTierFactorSet.all.each do |rfs|
        ...
        ::BenefitMarkets::Products::ActuarialFactors::CompositeRatingTierActuarialFactor.create!(
