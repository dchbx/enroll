...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.cancel' => "Cancel",
  :'en.confirm_creation_of_new_portal' => "Confirm Creation of New Portal",
  ...
  :'en.none' => "None",
  :'en.new_consumer_application' => "New Consumer Application",
  :'en.new_employee_application' => "New Employee Application",
  :'en.add_role' => "Add Role",
  :'en.add_portal' => "Add Portal",
  :'en.add_new_portal' => "Add New Portal",
