...
module TransportProfiles
  class Processes::Legacy::PushOutstandingMonthlyEnrollmentsReport < Processes::Process
    def initialize(report_file_name, gateway)
      super("Distribute system generated legacy outstanding monthly enrollments report", gateway)
