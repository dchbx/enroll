...
module SponsoredBenefits
  class BenefitMarket
    ...
    SERVICE_MARKET_KINDS = [:aca_shop, :aca_individual].freeze
    INITIAL_OPEN_ENROLLMENT_PERIOD_KINDS = [:monthly_rolling, :annual_open_enrollment].freeze
    ...
    def next_initial_enrollment_effective_date; end

    def next_renewal_enrollment_effective_date; end
    ...
    def benefit_products_by_effective_date_and_kind(effective_date, _benefit_product_kind)
