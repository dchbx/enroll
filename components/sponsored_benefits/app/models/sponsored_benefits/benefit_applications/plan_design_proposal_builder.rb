  ...
  module BenefitApplications
    class PlanDesignProposalBuilder
      ...
      def plan_design_proposal
        # Perform Validations
        @plan_design_proposal if has_access?
      end
      ...
      def has_access?
        ...
        return true if broker_agency_accounts.present? && broker_agency_accounts.any?(&:is_active?)

        raise "You no longer have permission to import employer information." if broker_agency_accounts.present?
