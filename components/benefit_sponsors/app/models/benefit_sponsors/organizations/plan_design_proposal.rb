...
module BenefitSponsors
  module Organizations
    class PlanDesignProposal
      ...
      embedded_in :plan_design_organization, class_name: "BenefitSponsors::Organizations::PlanDesignOrganization"
      ...
      class << self
        ...
        def find_quote(quote_claim_code)
          ...
          organization = BenefitSponsors::Organizations::PlanDesignOrganization.where(
        ...
        def claim_code_status?(quote_claim_code)
          ...
          if quote.present?
            [quote.aasm_state, quote] # quote is present, return its current status.
          else
        ...
        def build_plan_year_from_quote(employer_profile, quote)
          builder = BenefitSponsors::BenefitApplications::EmployerProfileBuilder.new(quote, employer_profile)
