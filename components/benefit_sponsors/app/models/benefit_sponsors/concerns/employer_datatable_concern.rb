  ...
  module Concerns
    module EmployerDatatableConcern
      ...
      included do
        ...
        scope :created_in_the_past,    lambda { |compare_date = TimeKeeper.date_of_record|
                                         where(
                                           :created_at.lte => compare_date
                                         )
                                       }

        scope :attestations_by_kind, lambda { |attestation_kind|
                                       ...
                                       self.where(:organization.in => orgs.collect(&:id))
                                     }

        scope :employer_attestations, lambda {
        ...
        scope :benefit_application_enrolling, lambda {
        ...
        scope :benefit_application_enrolling_initial, lambda {
        ...
        scope :benefit_application_enrolling_renewing, lambda {
        ...
        scope :benefit_application_enrolling_initial_oe, lambda {
        ...
        scope :benefit_application_enrolling_renewing_oe, lambda {
        ...
        scope :effective_date_begin_on, lambda { |compare_date|
                                          where(:"benefit_applications.effective_period.min" => compare_date)
                                        }

        scope :benefit_application_renewing, lambda {
