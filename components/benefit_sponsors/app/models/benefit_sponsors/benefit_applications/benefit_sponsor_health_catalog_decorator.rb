  ...
  module BenefitApplications
    class BenefitSponsorHealthCatalogDecorator < SimpleDelegator
      ...
      def single_issuer_options
        ...
        plan_options[:single_issuer] && Hash[plan_options[:single_issuer].sort_by { |k, _v| k }].each do |k, v|
      ...
      def single_product_options
        ...
        plan_options[:single_product] && Hash[plan_options[:single_product].sort_by { |k, _v| k }].each do |k, v|
