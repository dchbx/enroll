...
module Effective
  module Datatables
    class BenefitSponsorsGeneralAgencyDataTable < Effective::MongoidDatatable
      ...
      def collection
        general_agency_profile = ::BenefitSponsors::Organizations::GeneralAgencyProfile.find(attributes[:id])
        @employer_list = BenefitSponsors::Organizations::Organization.by_general_agency_profile(general_agency_profile.id)
      end
