...
RSpec.describe 'BenefitSponsors::ModelEvents::InitialEmployerSecondRemainderToPublishPlanYear', dbclean: :around_each do
  ...
  let!(:date_mock_object) { TimeKeeper.date_of_record.next_month.beginning_of_month - 1.day}
