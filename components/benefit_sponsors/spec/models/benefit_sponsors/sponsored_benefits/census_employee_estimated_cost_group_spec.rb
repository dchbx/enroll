...
module BenefitSponsors
  RSpec.describe BenefitSponsors::SponsoredBenefits::CensusEmployeeEstimatedCostGroup::CensusEmployeeMemberGroupMapper, "given:
    ...
    describe 'eligible_employee_criteria' do
      ...
      let!(:ce1)                          { FactoryBot.create(:census_employee, :with_enrolled_census_employee, benefit_sponsorship_id: benefit_sponsorship.id) }
      let!(:ce2)                          { FactoryBot.create(:census_employee, benefit_sponsorship_id: benefit_sponsorship.id) }
