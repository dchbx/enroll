  ...
  module ClientProductSpecHelpers
    module CCA
      ...
      def create_dental_only_carrier_plan_samples(
        ...
        local_service_area_id = BSON::ObjectId.new
        ...
        product_2_props = dental_shop_product_props_for(
          issuer_profile_id,
          "Carrier 3 Dental Only - Dental - Local",
          "32345MA0260002",
          effective_period,
          "gold",
      ...
      def create_health_and_dental_carrier_plan_samples(
        ...
        product_2_props = health_shop_product_props_for(
          issuer_profile_id,
          "Carrier 2 Health and Dental - Metal and Carrier 2",
          "22345MA0260002",
          effective_period,
          "gold",
          local_service_area_id,
      ...
      def create_health_only_carrier_plan_samples(
        ...
        product_4_props = health_shop_product_props_for(
          issuer_profile_id,
          "Carrier 1 Health - Carrier 1 - Local",
          "12345MA0260004",
          effective_period,
          "gold",
          local_service_area_id,
        ...
        product_6_props = health_shop_product_props_for(
          issuer_profile_id,
          "Carrier 1 Health - Composite 2 - Local",
          "12345MA0260006",
          effective_period,
          "platinum",
          local_service_area_id,
      ...
      def sole_source_health_product_package_from_product_props(product_props_list, effective_period)
        ...
        product_package_id = BSON::ObjectId.new
        {
          ...
          pricing_model: ::BenefitSponsors::PricingModelSpecHelpers.composite_pricing_model,
          contribution_model: ::BenefitSponsors::ContributionModelSpecHelpers.composite_contribution_model
        }
      end
