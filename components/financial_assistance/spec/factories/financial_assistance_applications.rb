...
FactoryBot.define do
  ...
  factory :financial_assistance_application, class: "::FinancialAssistance::Application" do
    ...
    trait :with_applicants do
      applicants {[
        FactoryBot.build(:financial_assistance_applicant, :male, :with_home_address, application: self, first_name: 'john', last_name: 'adams', family_member_id: family.primary_applicant.id, dob: 40.years.ago, ssn: '472743442'),
