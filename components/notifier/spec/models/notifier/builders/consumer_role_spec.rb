...
RSpec.describe Notifier::Builders::ConsumerRole, :dbclean => :after_each do
  ...
  describe "A new model instance" do
    ...
    let(:consumer_role) { consumer_role_class.new }

    let!(:person) { instance_double("Person", consumer_role: consumer_role, hbx_id: "a16f4029916445fcab3dbc44bb7aadd0", first_name: "Test", last_name: "Data", middle_name: "M", name_sfx: "Jr") }
  ...
  describe "A uqhp_eligible in aqhp event" do
    ...
    let!(:person2) { instance_double("Person", :with_consumer_role, hbx_id: "a16f4029916445fcab3dbc44bb7aadd1", first_name: "Test2", last_name: "Data2") }
